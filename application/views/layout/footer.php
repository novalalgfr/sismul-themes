        ...
        <div class="w-full max-w-5xl bg-darkCard border border-darkBorder rounded-[2rem] px-8 py-6 flex flex-col md:flex-row justify-between items-center shadow-2xl">
            ...
            <div class="flex space-x-4 mt-4 md:mt-0">
                <a href="#" class="w-8 h-8 rounded-full bg-[#0a0a0a] border border-darkBorder flex items-center justify-center text-neutral-400 hover:text-white hover:border-neutral-500 transition-all">
